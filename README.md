...
The axes2 widget shows the XYZA values of the axes2 of your CNC controller. It also enables you to jog, home, change units, and change Work Coordinate Systems.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Widget / XYZ axes2 v2
...
| Description           | The axes2 widget shows the XYZA values of the axes2 of your CNC controller. It also enables you to jog, home, change units, and change Work Coordinate Systems. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/Coughtry/widget-axes/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/coughtry/widget-axes1 |
| Github URL            | http://github.com/Coughtry/widget-axes |
| Test URL              | https://preview.c9users.io/coughtry/widget-axes1/widget.html |
